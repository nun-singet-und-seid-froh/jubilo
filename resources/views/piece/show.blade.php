...
$information_items = [
  ...
  'text' => ['caption' => 'Text', 'var' => $data['text']],
...
$download_items = [
  ...
  'midi' => ['caption' => 'Übungs-MIDI', 'var' => $data['midi']['string'], 'link' => $data['midi']['link']],
                    ...
                    <div class="row">
                        @foreach ($download_items as $item)
                            ...
                            @if ($item['caption'] == "Quellcode")
                                <div class="col-md-8"><a href="{{ $item['link'] }}" target="_blank" class="external">{{ $item['var'] }}</a></div>
                            @else  
